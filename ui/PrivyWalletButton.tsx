      ...
      <Menu.Root>
        ...
        <Menu.Portal>
          <Menu.Positioner align="end" sideOffset={8}>
            <Menu.Popup className="z-50 min-w-[180px] overflow-hidden rounded-2xl border border-panel-border bg-panel-bg-darker p-1.5 shadow-[0_20px_60px_var(--panel-shadow)] outline-none transition-all data-ending-style:scale-95 data-starting-style:scale-95 data-ending-style:opacity-0 data-starting-style:opacity-0">
              <Menu.Item
                className="flex cursor-pointer items-center gap-2.5 rounded-xl px-2.5 py-2 text-[13px] text-panel-text outline-none transition-colors data-highlighted:bg-input-bg data-highlighted:text-panel-text-active"
